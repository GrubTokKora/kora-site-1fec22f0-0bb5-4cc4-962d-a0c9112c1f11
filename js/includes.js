    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="navbar-inner flex justify-between items-center">
        <a href="index.html" class="flex items-center gap-3 group" aria-label="Veda Healing Spa Home">
          <img src="assets/img/1785242213_6czo1c.webp" alt="Veda Healing Spa" class="header-logo" width="185" height="170" loading="eager" decoding="async">
        </a>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="index.html" class="footer-logo-link" aria-label="Veda Healing Spa Home">
          <img src="assets/img/1785242213_6czo1c.webp" alt="Veda Healing Spa" class="footer-logo" width="185" height="170" loading="lazy" decoding="async">
        </a>
